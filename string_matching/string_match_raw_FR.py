...
#    folder =  '/Users/sumithra/DSV/MeDESTO/CLEFeHealthSharedTask2018/IT/training/raw/corpus/dataset_division/'
    folder =  '/Users/sumithra/DSV/MeDESTO/CLEFeHealthSharedTask2018/FR/training/raw/corpus/'
    #### INPUT FILES #####
    files_to_match = []
    ## raw  
    ## raw training
#    files_to_match.append('CausesBrutes_FR_2006-2012')
#    files_to_match.append('CausesBrutes_FR_2013')
    files_to_match.append('CausesBrutes_FR_2014')
